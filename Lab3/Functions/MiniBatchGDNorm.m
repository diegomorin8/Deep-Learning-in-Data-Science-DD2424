function [Wstar, bstar, val_loss, train_loss] = MiniBatchGDNorm(X, Y, X_val, Y_val, GDparams, W, b ,lambda, display, eta_decay, mW, mb, rho, X_test, y_test)
...
for ep=1:n_epochs
    ...
    for j=1:N/n_batch
        ...
        % Forward pass
        [P, h, s, s_norm, mu_, v] = ForwardBatch(X, W, b);

        % Backward pass
        [Grad_W, Grad_b] = BackwardBN(X, Y, P, W, h, s, s_norm, mu_, v, lambda);
